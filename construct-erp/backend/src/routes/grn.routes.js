      ...
      for (let i = 0; i < items.length; i++) {
        ...
        await client.query(
          `INSERT INTO grn_items (
            grn_id, material_name, quantity_received, unit, po_item_id, quality_remarks, batch_number, expiry_date, sort_order
          ) VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9)`,
          [grnId, it.material_name || null, it.quantity_received, it.unit, it.po_item_id || null, it.quality_remarks || null, it.batch_number || null, it.expiry_date || null, i + 1]
        );
        totalQty += parseFloat(it.quantity_received);
      }
