    ...
    <div className="flex flex-col h-full bg-slate-50">
      ...
      <div className="bg-white border-b border-slate-200 px-6 py-4 flex items-center justify-between flex-shrink-0">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg font-semibold text-slate-800">Tender Issuance</h1>
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-5">
          ...
          {KPI_STYLES.map(k => {
            ...
            return (
              ...
              >
                ...
                <div className={`text-xl font-bold ${k.numCls}`}>{stats[k.key] ?? 0}</div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-white rounded-xl border border-slate-200 p-4 flex items-center gap-4">
            ...
            <div>
              <p className="text-xs text-slate-500 uppercase tracking-wide">Total Estimated</p>
              <p className="text-lg font-bold text-slate-800">{fmtCr(stats.total_estimated)}</p>
            </div>
          </div>
          <div className="bg-white rounded-xl border border-slate-200 p-4 flex items-center gap-4">
            ...
            <div>
              <p className="text-xs text-slate-500 uppercase tracking-wide">Total Awarded</p>
              <p className="text-lg font-bold text-emerald-700">{fmtCr(stats.total_awarded)}</p>
            </div>
          </div>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="bg-white rounded-xl border border-slate-200 py-16 text-center">
            ...
            <p className="text-slate-400 text-sm mt-1">Click "New Tender" to issue your first tender</p>
          </div>
        ) : (
        ...
        <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] flex flex-col">
            <div className="flex items-center justify-between px-6 py-4 border-b border-slate-200">
              <h2 className="text-base font-semibold text-slate-800">Issue New Tender</h2>
            ...
            <form onSubmit={handleCreate} className="flex-1 overflow-y-auto p-6 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-xs font-medium text-slate-600 mb-1">Tender Type</label>
                  <select
                ...
                <div>
                  <label className="block text-xs font-medium text-slate-600 mb-1">Work Package</label>
                  <input
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  <label className="block text-xs font-medium text-slate-600 mb-1">Contract Duration (days)</label>
                  <input
                    type="number" min="1"
              ...
              <div className="grid grid-cols-3 gap-3">
                <div>
                  <label className="block text-xs font-medium text-slate-600 mb-1">Pre-Bid Date</label>
                  <input
                ...
                <div>
                  <label className="block text-xs font-medium text-slate-600 mb-1">Bid Close Date</label>
                  <input
                ...
                <div>
                  <label className="block text-xs font-medium text-slate-600 mb-1">Expected Start</label>
                  <input
              ...
              <div className="flex items-center gap-3 p-3 bg-slate-50 rounded-lg border border-slate-200">
                ...
                />
                <label htmlFor="emd" className="text-sm text-slate-700 font-medium">EMD Required</label>
                {form.emd_required && (
                  <input
                    type="number" min="0"
              ...
              {/* Description */}
              <div>
                <label className="block text-xs font-medium text-slate-600 mb-1">Description / Scope Summary</label>
                <textarea
