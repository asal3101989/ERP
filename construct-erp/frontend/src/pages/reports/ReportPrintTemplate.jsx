    ...
    <div ref={ref} className="p-16 bg-white text-slate-900 min-h-screen font-sans border-[16px] border-slate-900 sticky top-0">
      ...
      <div className="flex justify-between items-start border-b-8 border-slate-900 pb-10 mb-12">
        <div className="space-y-3">
           <div className="flex items-center gap-4">
              ...
              <div>
                 <h1 className="text-4xl font-black uppercase italic tracking-tighter leading-none">BCIM ENGINEERING <span className="text-slate-500">GROUP</span></h1>
        ...
        <div className="text-right">
           <div className="text-2xl font-black uppercase tracking-tight italic bg-slate-900 text-white px-6 py-2 inline-block rounded-sm transform -skew-x-12">
             {title || 'STRATEGIC REPORT'}
           </div>
           <div className="text-xs font-black text-slate-400 mt-4 tracking-widest uppercase italic">CONFIDENTIAL • BCIM-CORE-AUDIT</div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-4 gap-8 bg-slate-50 p-8 rounded-2xl border border-slate-200 mb-12">
        <div className="space-y-1">
           <label className="text-[8px] font-black text-slate-400 uppercase tracking-widest">Report Cycle</label>
           <div className="flex items-center gap-2 text-xs font-black uppercase"><Calendar size={14}/> {dayjs().format('MMMM YYYY')}</div>
        </div>
        <div className="space-y-1 border-l border-slate-200 pl-8">
           <label className="text-[8px] font-black text-slate-400 uppercase tracking-widest">Project Cluster</label>
           <div className="flex items-center gap-2 text-xs font-black uppercase"><Globe size={14}/> Pan-India Active</div>
        </div>
        <div className="space-y-1 border-l border-slate-200 pl-8">
           <label className="text-[8px] font-black text-slate-400 uppercase tracking-widest">Verification Status</label>
           <div className="flex items-center gap-2 text-xs font-black uppercase text-emerald-600"><ShieldCheck size={14}/> Certified Authentic</div>
        </div>
      ...
      <div className="grid grid-cols-2 gap-16 mb-16">
         <div className="space-y-8">
            <h3 className="text-xs font-black text-slate-900 uppercase tracking-[0.2em] border-b-2 border-slate-900 pb-2">I. Executive Summary (AI-Audited)</h3>
            ...
            <h3 className="text-xs font-black text-slate-900 uppercase tracking-[0.2em] border-b-2 border-slate-900 pb-2">II. Project Health Index</h3>
         ...
         <div className="space-y-10">
            <h3 className="text-xs font-black text-slate-900 uppercase tracking-[0.2em] border-b-2 border-slate-900 pb-2 italic">III. Visualized Trends</h3>
            <div className="aspect-[4/3] bg-slate-50 border border-slate-200 rounded-3xl flex items-center justify-center relative overflow-hidden group">
               ...
               <span className="text-[10px] font-black text-slate-300 uppercase italic tracking-widest z-10">[ DASHBOARD SNAPSHOT ATTACHED ]</span>
            </div>
            
            <div className="p-8 bg-slate-900 text-white rounded-3xl space-y-4 shadow-2xl transform rotate-1">
               <h4 className="text-[10px] font-black tracking-widest uppercase italic border-b border-white/20 pb-2">Strategic Insight</h4>
         ...
         <div className="grid grid-cols-3 gap-20 text-center">
            {['PROJECT DIRECTOR', 'CHIEF AUDITOR', 'STRATEGIC HEAD'].map((role, i) => (
               <div key={i} className="space-y-4">
                  <div className="h-24 border-b-2 border-slate-200 flex items-center justify-center italic text-slate-200 font-black tracking-widest text-lg opacity-20">
                     [ AUTHENTICATED ]
                  </div>
                  <div>
      ...
      {/* Global Footer */}
      <div className="fixed bottom-12 left-16 right-16 flex justify-between items-center text-[7.5px] font-black text-slate-300 uppercase tracking-[0.3em] border-t border-slate-100 pt-6 italic">
