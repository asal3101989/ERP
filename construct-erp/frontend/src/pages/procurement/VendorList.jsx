...
const TYPES = {
  ...
  service_provider:   { label: 'Service Provider',    dot: 'bg-slate-400',   badge: 'bg-slate-100 text-slate-600 border-slate-200' },
  'Service Provider': { label: 'Service Provider',    dot: 'bg-slate-400',   badge: 'bg-slate-100 text-slate-600 border-slate-200' },
    ...
    <div className="p-6 md:p-8 max-w-7xl mx-auto min-h-screen bg-[#f4f6f9]">
      ...
      {isLoading ? (
        ...
        <div className="py-20 text-center border-2 border-dashed border-slate-200 rounded-xl bg-white">
          ...
          <p className="text-xs text-slate-400 mt-1">Adjust your search or register a new vendor</p>
        </div>
      ) : (
        <div className="bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden">
          {/* Table Head */}
          <div className="grid grid-cols-12 gap-3 px-4 py-3 border-b border-slate-100 bg-slate-50 text-xs font-semibold text-slate-500">
                  ...
                  >
                    ...
                    <div className="col-span-4 flex items-center gap-3 min-w-0">
                      ...
                      <div className="min-w-0">
                        ...
                        <div className="text-xs text-slate-400 font-mono">{v.vendor_code}</div>
                      </div>
                    </div>
                    ...
                    {/* GSTIN */}
                    <div className="col-span-2 text-xs font-mono text-slate-600 truncate">{v.gstin || '—'}</div>
                    ...
                    <div className="col-span-1 flex items-center justify-end gap-1" onClick={e => e.stopPropagation()}>
                      <button
                        onClick={() => setExpanded(isOpen ? null : v.id)}
                        className="w-7 h-7 flex items-center justify-center rounded-lg border border-slate-200 text-slate-400 hover:border-indigo-300 hover:text-indigo-600 transition-all"
                      >
                    ...
                    <div className="bg-slate-50 border-t border-slate-100 px-6 py-4 space-y-3">
                      ...
                      {v.notes && (
                        <div className="pt-2 border-t border-slate-100">
                          <div className="text-[10px] text-slate-400 font-medium uppercase tracking-wider mb-1">Notes</div>
