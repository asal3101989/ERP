            ...
            <div className="w-96 flex-shrink-0 bg-white rounded-xl border border-slate-200 flex flex-col overflow-hidden">
              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-3">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div>
                    <label className="block text-xs font-medium text-slate-500 mb-1">Order Date <span className="text-red-500">*</span></label>
                ...
                <div className="border border-slate-200 rounded-lg overflow-hidden">
                  ...
                  {curItem.form.items.map((it, idx) => (
                    <div key={idx} className="p-2 border-b border-slate-100 last:border-0 space-y-1.5">
                      <div className="flex items-center gap-1">
                        <span className="text-xs text-slate-400 font-semibold w-4 flex-shrink-0">{idx + 1}.</span>
                        <input
                      ...
                      <div className="grid grid-cols-4 gap-1 ml-5">
                        ...
                        <div>
                          <label className="block text-xs text-slate-400 mb-0.5">Unit</label>
                        ...
                        <div>
                          <label className="block text-xs text-slate-400 mb-0.5">Rate</label>
                        ...
                        <div>
                          <label className="block text-xs text-slate-400 mb-0.5">GST%</label>
                  ...
                  {totals && totals.grandTotal > 0 && (
                    <div className="bg-indigo-50 px-3 py-2 space-y-0.5 border-t border-indigo-100">
                      ...
                      <div className="flex justify-between text-xs font-bold text-slate-900 pt-0.5 border-t border-indigo-200">
            ...
            <div className="bg-white rounded-xl border border-slate-200 p-6 space-y-4">
                ...
                {saved.map((r, i) => {
                  ...
                  return (
                    <div key={i} className="flex items-center justify-between px-3 py-2 text-xs">
                      ...
                      <span className="font-semibold text-slate-900">₹{inr(t.grandTotal)}</span>
                    </div>
                  );
                })}
              </div>
              ...
              <div className="flex gap-3">
                <button onClick={() => setStep('review')}
                  className="flex-1 bg-slate-100 hover:bg-slate-200 text-slate-700 text-sm font-semibold rounded-lg py-2.5">
                  ← Back to Review
                </button>
