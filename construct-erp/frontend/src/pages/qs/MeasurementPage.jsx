      ...
      <div className="sticky top-0 z-30 bg-white border-b border-[#e2e6ec] shadow-sm">
        <div className="px-6 py-3 flex items-center justify-between gap-4 flex-wrap">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-[15px] font-bold text-[#1a1c21] leading-none">Measurement Book</h1>
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <button
              ...
              className="h-9 flex items-center gap-1.5 px-3 rounded-xl border border-indigo-300 bg-indigo-50 text-indigo-700 text-xs font-semibold hover:bg-indigo-100 transition-colors"
            >
      ...
      <div className="px-6 py-5 space-y-5">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            ...
            >
              <div className={clsx('text-2xl font-black', st.color)}>{st.val}</div>
              <div className="text-[10px] text-[#8e94a3] font-semibold uppercase tracking-wider mt-1">{st.label}</div>
            </button>
          ))}
        </div>
              ...
              <tr className="bg-[#f4f6f9] border-b border-[#e2e6ec]">
                {['CSI No', 'BOQ Item', 'Location', 'Date', 'Dimensions (L×B×H×Nos)', 'Net Qty', 'Unit', 'Status', ''].map((h, i) => (
                  <th
                    key={i}
                    className={clsx(
                      'py-3 px-4 text-[10px] font-semibold text-[#6a6f7d] uppercase tracking-wider',
                ...
                filtered.map((m) => (
                  ...
                  >
                    ...
                    <td className="py-3 px-4">
                      <div className="font-semibold text-indigo-600 font-mono text-[11px]">{m.sr_no || '—'}</div>
                      {m.mb_number && <div className="text-[9px] text-slate-400 font-mono mt-0.5">{m.mb_number}</div>}
                    </td>
                    {/* BOQ Item */}
                    ...
                    {/* Net Qty */}
                    <td className="py-3 px-4 text-right font-mono font-semibold text-[#1a1c21]">
                      {num(m.net_quantity)}
                    </td>
                    {/* Unit */}
            ...
            >
              ...
              <div className="px-6 py-4 border-b border-[#e2e6ec] flex items-start justify-between">
                <div>
                  ...
                  <h2 className="text-[16px] font-bold text-[#1a1c21] font-mono">
              ...
              <div className="px-6 py-4 space-y-4 max-h-[60vh] overflow-y-auto">
                {/* Description */}
                <div>
                  <div className="text-[10px] font-semibold text-[#8e94a3] uppercase tracking-wider mb-1">Description</div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <div className="text-[10px] font-semibold text-[#8e94a3] uppercase tracking-wider mb-1">Location</div>
                    <div className="text-[12px] font-medium text-[#1a1c21]">{selected.location || '—'}</div>
                  </div>
                  <div>
                    <div className="text-[10px] font-semibold text-[#8e94a3] uppercase tracking-wider mb-1">Drawing Ref</div>
                  ...
                  <table className="w-full text-[12px]">
                      ...
                      <tr className="bg-[#f4f6f9] border-b border-[#e2e6ec]">
                        {['Nos', 'L (m)', 'B (m)', 'H (m)', 'Net Qty'].map((h, i) => (
                          <th key={i} className={clsx(
                            'py-2 px-3 text-[10px] font-semibold text-[#6a6f7d] uppercase tracking-wider',
                    ...
                    <tbody>
                      <tr className="divide-x divide-[#f0f2f5]">
                        ...
                        <td className="py-3 px-3 text-right font-mono font-semibold text-indigo-600">{num(selected.net_quantity)}</td>
                      </tr>
                      {parseFloat(selected.deduction || 0) > 0 && (
                        <tr className="bg-red-50 border-t border-red-100">
                          <td colSpan={4} className="py-2 px-4 text-right text-[10px] font-semibold text-red-500 uppercase tracking-wider">Less Deduction</td>
                      ...
                      <tr className="bg-[#f4f6f9] border-t border-[#e2e6ec]">
                        <td colSpan={4} className="py-3 px-4 text-right text-[10px] font-semibold text-[#6a6f7d] uppercase tracking-wider">
                          Net Quantity &nbsp;({selected.unit || selected.boq_unit || '—'})
                        </td>
                        <td className="py-3 px-3 text-right font-mono font-bold text-[15px] text-[#1a1c21]">
                ...
                {showReject && (
                  <div className="space-y-2">
                    <label className="text-[10px] font-semibold text-[#6a6f7d] uppercase tracking-wider">Rejection Remarks</label>
                    <textarea
                  ...
                  {showReject ? (
                    <>
                      <button
                        ...
                        className="h-9 px-4 rounded-xl border border-[#e2e6ec] bg-white text-[12px] font-semibold text-[#6a6f7d] hover:bg-[#f4f6f9] transition-colors"
                      >
                        Cancel
                      </button>
                      <button
                        ...
                        className="flex-1 h-9 px-4 rounded-xl bg-red-500 text-white text-[12px] font-semibold hover:bg-red-600 transition-colors disabled:opacity-60"
                      >
                        Confirm Reject
                      </button>
                    </>
                    ...
                    <>
                      <button
                        ...
                        className="h-9 px-4 rounded-xl border border-red-200 bg-red-50 text-red-500 text-[12px] font-semibold hover:bg-red-100 transition-colors"
                      >
                        Reject
                      </button>
                      <button
                        ...
                        disabled={approveMutation.isPending}
                        className="flex-1 h-9 px-4 rounded-xl bg-indigo-600 text-white text-[12px] font-semibold hover:bg-indigo-500 transition-colors disabled:opacity-60"
                      >
            ...
            >
              ...
              <div className="px-6 py-4 border-b border-[#e2e6ec] flex items-center justify-between flex-shrink-0 bg-white">
                <div className="flex items-center gap-2">
                  ...
                  <h2 className="text-[14px] font-bold text-[#1a1c21]">New Measurement Entry</h2>
                </div>
                <button
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-1.5">
                    <label className="block text-[10px] font-semibold text-[#6a6f7d] uppercase tracking-wider">Project</label>
                    <div className="relative">
                      <select
                  ...
                  <div className="space-y-1.5">
                    <label className="block text-[10px] font-semibold text-[#6a6f7d] uppercase tracking-wider">BOQ Item</label>
                    <div className="relative">
                      <select
                        className="w-full h-9 pl-3 pr-8 border border-[#d8dce1] rounded-xl bg-white text-[12px] text-[#1a1c21] outline-none focus:border-indigo-400 appearance-none"
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-1.5">
                    <label className="block text-[10px] font-semibold text-[#6a6f7d] uppercase tracking-wider">Date</label>
                    <input
                      type="date"
                  ...
                  <div className="space-y-1.5">
                    <label className="block text-[10px] font-semibold text-[#6a6f7d] uppercase tracking-wider">Drawing Ref</label>
                    <input
                      type="text"
                ...
                {/* Description */}
                <div className="space-y-1.5">
                  <label className="block text-[10px] font-semibold text-[#6a6f7d] uppercase tracking-wider">Description</label>
                  <textarea
                ...
                {/* Location */}
                <div className="space-y-1.5">
                  <label className="block text-[10px] font-semibold text-[#6a6f7d] uppercase tracking-wider">Location</label>
                  <input
                    type="text"
                    className="w-full h-9 px-3 border border-[#d8dce1] rounded-xl bg-white text-[12px] text-[#1a1c21] outline-none focus:border-indigo-400 placeholder-[#8e94a3]"
                ...
                <div className="rounded-xl border border-[#e2e6ec] bg-[#f8f9fb] p-4 space-y-3">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[11px] font-bold text-[#1a1c21] uppercase tracking-wider">Geometric Dimensions</span>
                  </div>
                  <div className="grid grid-cols-5 gap-2">
                    {[
                      ...
                      <div key={field} className="space-y-1">
                        <label className="block text-[10px] font-semibold text-[#6a6f7d] text-center">{label}</label>
                        <input
                          type="number"
                          step="0.001"
                          min="0"
                  ...
                  <div className="mt-1 pt-3 border-t border-[#e2e6ec] flex items-center justify-between">
                    <div className="text-[10px] font-semibold text-[#6a6f7d] uppercase tracking-wider">
                      Net Qty = Nos × L × B × H − Ded
                    </div>
                    <div className="flex items-center gap-2">
                      <span className="text-[24px] font-black font-mono text-indigo-600">{netQty.toFixed(3)}</span>
                ...
                {/* Remarks */}
                <div className="space-y-1.5">
                  <label className="block text-[10px] font-semibold text-[#6a6f7d] uppercase tracking-wider">Remarks (optional)</label>
                  <input
                    type="text"
                    className="w-full h-9 px-3 border border-[#d8dce1] rounded-xl bg-white text-[12px] text-[#1a1c21] outline-none focus:border-indigo-400 placeholder-[#8e94a3]"
              ...
              <div className="px-6 py-4 border-t border-[#e2e6ec] flex gap-2 flex-shrink-0 bg-white">
                <button
                  type="button"
                  onClick={() => { setShowForm(false); resetForm(); }}
                  className="h-9 px-5 rounded-xl border border-[#e2e6ec] bg-white text-[12px] font-semibold text-[#6a6f7d] hover:bg-[#f4f6f9] transition-colors"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="h-9 px-5 rounded-xl border border-[#d8dce1] bg-white text-[12px] font-semibold text-[#6a6f7d] hover:bg-[#f4f6f9] transition-colors disabled:opacity-50"
                >
                  Save Draft
                </button>
                <button
                  ...
                  disabled={createMutation.isPending || !form.boq_item_id || !form.description}
                  className="flex-1 h-9 px-5 rounded-xl bg-indigo-600 text-white text-[12px] font-semibold hover:bg-indigo-500 transition-colors disabled:opacity-60"
                >
