    ...
    <div className="min-h-screen bg-[#f4f6f9] font-sans text-sm">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h1 className="text-[16px] font-black text-[#1a1c21] font-mono uppercase tracking-tight">{b.bill_number}</h1>
              <span className={clsx('inline-flex items-center px-2.5 py-0.5 rounded-full text-[10px] font-bold border', st.cls)}>
                {st.label}
              </span>
            </div>
            ...
            <>
              ...
              {b.status === 'submitted' && CAN_VERIFY.includes(role) && (
                <button
                  ...
                  className="h-9 px-4 rounded-xl text-[11px] font-bold border border-red-200 bg-red-50 text-red-500 hover:bg-red-100 transition-colors disabled:opacity-50"
                >
                  Reject
                </button>
              )}
              ...
              {b.status === 'submitted' && CAN_VERIFY.includes(role) && (
                <button
                  ...
                  className="h-9 px-5 rounded-xl text-[11px] font-bold bg-blue-600 text-white hover:bg-blue-500 transition-colors shadow-sm shadow-blue-600/20 disabled:opacity-50 flex items-center gap-2"
                >
                  <ShieldCheck size={14} />
              ...
              {b.status === 'verified' && CAN_CERTIFY.includes(role) && (
                <button
                  ...
                  className="h-9 px-5 rounded-xl text-[11px] font-bold bg-emerald-600 text-white hover:bg-emerald-500 transition-colors shadow-sm shadow-emerald-600/20 disabled:opacity-50 flex items-center gap-2"
                >
              ...
              {b.status === 'certified' && CAN_PAY.includes(role) && (
                <button
                  ...
                  className="h-9 px-5 rounded-xl text-[11px] font-bold bg-teal-600 text-white hover:bg-teal-500 transition-colors shadow-sm disabled:opacity-50 flex items-center gap-2"
                >
      ...
      <div className="px-6 py-5 space-y-5">
        ...
        <div className="bg-white rounded-2xl border border-[#e2e6ec] shadow-sm p-5">
          <div className="text-[9px] font-black text-[#8e94a3] uppercase tracking-widest mb-4">Approval Lifecycle</div>
              ...
              return (
                <React.Fragment key={s.key}>
                  <div className="flex flex-col items-center flex-1">
                    ...
                    <div className={clsx(
                      'text-[9px] font-black uppercase tracking-wider mt-2',
          ...
          <div className="lg:col-span-2 space-y-5">
            ...
            {(b.bill_period_from || b.work_description) && (
              <div className="bg-white rounded-2xl border border-[#e2e6ec] shadow-sm p-4 flex flex-wrap gap-4">
                {b.bill_period_from && (
                  <div>
                    <div className="text-[9px] font-black text-[#8e94a3] uppercase tracking-widest">Bill Period</div>
                    <div className="text-[12px] font-bold text-[#1a1c21] mt-0.5">
                ...
                {b.work_description && (
                  <div className="flex-1">
                    <div className="text-[9px] font-black text-[#8e94a3] uppercase tracking-widest">Work Description</div>
            ...
            <div className="bg-white rounded-2xl border border-[#e2e6ec] shadow-sm overflow-hidden">
              <div className="px-5 py-3.5 border-b border-[#e2e6ec] flex items-center gap-2">
                ...
                <h2 className="text-[11px] font-black text-[#1a1c21] uppercase tracking-wide">Line Item Breakdown</h2>
                <span className="ml-auto text-[9px] font-bold text-[#8e94a3] bg-[#f4f6f9] px-2 py-0.5 rounded-full">
                ...
                <table className="w-full">
                  <thead>
                    <tr className="bg-[#f8fafc] border-b border-[#e2e6ec]">
                      <th className="px-5 py-2.5 text-left text-[10px] font-bold text-[#8e94a3] uppercase tracking-wider">Specification</th>
                      <th className="px-4 py-2.5 text-right text-[10px] font-bold text-[#8e94a3] uppercase tracking-wider w-28">Previous</th>
                      <th className="px-4 py-2.5 text-right text-[10px] font-bold text-indigo-500 uppercase tracking-wider w-28 bg-blue-50/50">Current</th>
                      <th className="px-5 py-2.5 text-right text-[10px] font-bold text-[#8e94a3] uppercase tracking-wider w-36">Value</th>
                    </tr>
                  </thead>
                    ...
                    {(b.items || []).map((it, idx) => (
                      <tr key={idx} className="hover:bg-[#f8fafc] transition-colors">
                        <td className="px-5 py-3">
                          <div className="text-[12px] font-semibold text-[#1a1c21] leading-snug">{it.description}</div>
                        ...
                        <td className="px-4 py-3 text-right font-mono text-[12px] font-bold text-indigo-600 bg-blue-50/20">
                          {(it.current_qty || 0).toLocaleString()}
                        </td>
                        <td className="px-5 py-3 text-right font-mono text-[13px] font-bold text-[#1a1c21]">
                          {inr(it.amount || (it.current_qty * it.rate))}
                        </td>
                      </tr>
                    ))}
                  ...
                  {(b.items || []).length > 0 && (
                    <tfoot>
                      <tr className="bg-slate-50 border-t border-[#e2e6ec]">
                        <td colSpan={3} className="px-5 py-3 text-[10px] font-black text-[#8e94a3] uppercase tracking-widest">
                          Gross Valuation
                        </td>
                        <td className="px-5 py-3 text-right font-mono text-[14px] font-black text-[#1a1c21]">
                          {inr(b.gross_amount)}
                        </td>
                      </tr>
                    </tfoot>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-2xl border border-[#e2e6ec] shadow-sm p-5">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-[11px] font-black text-[#1a1c21] uppercase tracking-wide">Payment Ledger</h3>
              </div>
              <div className="space-y-2.5">
                ...
                <div className="border-t-2 border-[#1a1c21] pt-3 mt-2">
                  <div className="text-[9px] font-black text-[#8e94a3] uppercase tracking-widest mb-1">
                    Total Certified Disbursement
                  </div>
                  <div className="text-[28px] font-black text-emerald-600 font-mono leading-none">
                    {inr(b.net_payable)}
                  </div>
                </div>
              </div>
            ...
            {b.status === 'paid' && (
              <div className="bg-teal-50 rounded-2xl border border-teal-200 shadow-sm p-5">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h3 className="text-[11px] font-black text-teal-800 uppercase tracking-wide">Payment Received</h3>
                  <span className="ml-auto text-[9px] font-black text-teal-600 bg-teal-100 border border-teal-200 px-2 py-0.5 rounded-full">SETTLED</span>
                </div>
                ...
                <div className="space-y-2.5">
                  {b.payment_date && (
                    <div className="flex items-center gap-2 text-[11px]">
                      ...
                      <span className="font-bold text-teal-900 ml-auto">{dayjs(b.payment_date).format('DD MMM YYYY')}</span>
                    </div>
                  )}
                  {b.payment_mode && (
                    <div className="flex items-center gap-2 text-[11px]">
                      ...
                      <span className="font-bold text-teal-900 ml-auto">{b.payment_mode}</span>
                    </div>
                  )}
                  {b.payment_ref && (
                    <div className="flex items-center gap-2 text-[11px]">
                      ...
                      <span className="font-bold text-teal-900 ml-auto font-mono">{b.payment_ref}</span>
                    </div>
                  )}
                  ...
                  <div className="border-t border-teal-200 pt-2.5 mt-1 space-y-2">
                    <div className="flex items-center gap-2 text-[11px]">
                      ...
                      <span className="font-semibold text-teal-900 ml-auto font-mono">{inr(b.net_payable)}</span>
                    </div>
                    {parseFloat(b.client_tds_amount || 0) > 0 && (
                      <div className="flex items-center gap-2 text-[11px]">
                        ...
                        <span className="font-semibold text-amber-700 ml-auto font-mono">− {inr(b.client_tds_amount)}</span>
                      </div>
                    )}
                  </div>

                  <div className="bg-teal-600 rounded-xl px-4 py-3 mt-1">
                    <div className="text-[9px] font-black text-teal-200 uppercase tracking-widest">Amount Actually Received</div>
                    <div className="text-[24px] font-black text-white font-mono leading-none mt-0.5">
...
function MetaRow({ icon: Icon, label, value }) {
  return (
    <div className="flex items-center gap-2 text-[11px]">
      ...
      <span className="font-semibold text-[#1a1c21] ml-auto text-right">{value}</span>
    </div>
  );
}
