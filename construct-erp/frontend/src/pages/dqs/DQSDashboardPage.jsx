        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(7, 1fr)', gap: 10, marginBottom: 24 }}>
          {[
            ...
            <motion.button
              ...
              onClick={() => navigate(`/dqs/bills?status=${Object.keys(STATUS_CONFIG)[i]}`)}
              style={{
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', gap: 16 }}>
          ...
          <GlassCard delay={0.75}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 14 }}>
              ...
              <button onClick={() => navigate('/dqs/bills')} style={{ fontSize: 11, color: '#6366f1', background: 'none', border: 'none', cursor: 'pointer', fontWeight: 600, display: 'flex', alignItems: 'center', gap: 3 }}>
