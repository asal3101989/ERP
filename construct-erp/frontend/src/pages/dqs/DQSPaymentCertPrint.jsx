// src/pages/dqs/DQSPaymentCertPrint.jsx
...
const inr  = (v) => Math.round(nv(v)).toLocaleString('en-IN');
...
export default function DQSPaymentCertPrint() {
  const { id } = useParams();
  const { data: bill, isLoading } = useQuery({
    queryKey: ['dqs-bill-print', id],
