...
import { dqsTrackerAPI, projectAPI } from '../../api/client';
...
function TrackerModal({ initial, onClose, projects }) {
  ...
  const mutation = useMutation({
    mutationFn: (data) => isEdit ? dqsTrackerAPI.update(initial.id, data) : dqsTrackerAPI.create(data),
...
function LiveTrackerTab({ projectFilter, search }) {
  const { data: rows = [], isLoading, isError, refetch, isFetching } = useQuery({
    ...
    queryFn: () => dqsTrackerAPI.lifecycle({
...
function ManualTrackerTab({ projectFilter, search, projects }) {
  ...
  const deleteMutation = useMutation({
    mutationFn: (id) => dqsTrackerAPI.delete(id),
...
/* ─── Page ───────────────────────────────────────────────────────────────────── */
export default function DQSMaterialTrackerPage() {
